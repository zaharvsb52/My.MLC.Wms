...
Ext.define('Ext.ux.desktop.Desktop', {
    ...
    createDesktopMenu: function () {
        ...
        ret.items.push(
                { text: 'Отображать окна рядом', handler: me.tileWindows, scope: me, minWindows: 1 },
                { text: 'Отображать окна стопкой', handler: me.cascadeWindows, scope: me, minWindows: 1 }
        );
    ...
    createWindowMenu: function () {
        ...
        return {
            defaultAlign: 'br-tr',
            items: [
                { text: 'Восстановить', handler: me.onWindowMenuRestore, scope: me },
                { text: 'Свернуть', handler: me.onWindowMenuMinimize, scope: me },
                { text: 'Развернуть', handler: me.onWindowMenuMaximize, scope: me },
                '-',
                { text: 'Закрыть все', handler: me.onWindowMenuCloseAll, scope: me },
                { text: 'Закрыть другие', handler: me.onWindowMenuCloseOther, scope: me },
                '-',
                { text: 'Закрыть', handler: me.onWindowMenuClose, scope: me }
            ],
            listeners: {
    ...
    onWindowMenuCloseAll: function () {
        ...
        me.windows.items.forEach(function (item) {
            item.close();
        });
    },
    ...
    onWindowMenuCloseOther: function () {
        var me = this,
            ...
            items = me.windows.items;

        var i = items.indexOf(win);
        if (i > -1) {
            items.splice(i, 1);
        }
    ...
    getDesktopZIndexManager: function () {
        ...
        return (windows.getCount() && windows.getAt(0) != null && windows.getAt(0).zIndexManager) || null;
    },
