Ext.define('MLC.wms.wf.ExternalTraffic_Create.ExternalTrafficCreateCard', {
                        ...
                        items: [
                            {
                                ...
                                items: [
                                    ...
                                    { name: 'WorkerPass_WorkerPassSeries__WorkerPassNumber', plugins: ['converttolat'], fieldLabel: 'Документ', emptyText: 'Введите номер документа', labelWidth: 120 },
                                    ...
                                    {
                                        xtype: 'textarea', fieldLabel: 'Адрес регистрации', margin: '0 0 0 0', labelWidth: 120, name: 'ExternalTrafficDriver_WorkerResidenceAddr',
                                        height: 102,
                        ...
                        items: [
                            {
                                ...
                                items: [
                                    { name: 'Vehicle_VehicleRN', plugins: ['converttolat'], fieldLabel: '№ ТС', emptyText: 'Введите номер ТС', labelWidth: 120 },
