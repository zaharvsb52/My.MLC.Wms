...
{
    public class CargoIwbLookupStructureDataProvider : TypedAutoLookupStructureDataProvider<WmsCargoIWB>
    {
        public CargoIwbLookupStructureDataProvider(IMetamodel metamodel,
