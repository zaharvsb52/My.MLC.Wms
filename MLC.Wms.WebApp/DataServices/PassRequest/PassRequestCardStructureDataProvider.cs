...
{
    public class PassRequestCardStructureDataProvider : AutoStructureDataProvider, ICardDataLoader
    {
        ...
        public PassRequestCardStructureDataProvider(IMetamodel metamodel,
        ...
        {
            return _bindingsCreator.With<YPassRequest>()
